#' @title Directional DEA model.
#'   
#' @description It solves directional, basic DEA models under constant, variable,
...
#'  
#' @seealso \code{\link{model_basic}}, \code{\link{model_lgo}}, \code{\link{model_qgo}}
#' 
#' @import lpSolve
#' 
#' @export
  ...
  for (i in 1:nde) {
    ...
    if (returnlp) {
      ...
      DMU[[i]] <- list(efficiency = rho,
                       ...
                       proj_input = proj_input, proj_output = proj_output,
